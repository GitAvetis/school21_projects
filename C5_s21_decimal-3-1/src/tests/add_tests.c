...
START_TEST(add_test_26) {
  s21_decimal dec1 = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, 0}, 0};
...
START_TEST(add_test_27) {
  float tmp2 = pow(2, 31);
  s21_decimal dec1 = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, tmp2}, 0};
...
//   s21_decimal src1 = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, 0},0};
//   s21_decimal src2 = {0};
//   float a = 0.01448;
...
//   s21_decimal src1 = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT,
//   ~(INT_MAX)}}; s21_decimal src2 = {0}; float a = -0.01448;
//   s21_from_float_to_decimal(a, &src2);
//   s21_decimal res_dec = {{0}, 0};
//   s21_add(src1, src2, &res_dec);
...
//   s21_decimal result = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, 0}};
...
//   s21_decimal etalon = {
//       {0b01110001001010101101101011101101,
...
//       0};
//   s21_decimal etalon = {
//       {0b10110110001010011011010111011010,
...
//   s21_decimal src1 =
//   {{0b11111111111111111111111111111111,0b11111111111111111111111111111111,0b11111111111111111111111111111111,0b00000000000000000000000000000000,},0};
...
START_TEST(test_add_1) {
  s21_decimal val1 = {{46521, 3, 0, 0}, 0};
  s21_decimal val2 = {{34521, 0, 0, 0}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
...
START_TEST(test_add_2) {
  s21_decimal val1 = {{0xFFFFFFFF, 3, 0, 0}, 0};
  s21_decimal val2 = {{1, 0, 0, 0}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
...
START_TEST(test_add_3) {
  s21_decimal val1 = {{56, 0, 0, 196608}, 0};
  s21_decimal val2 = {{13, 0, 0, 0}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
  ck_assert_int_eq(result, 0);
...
START_TEST(test_add_4) {
  s21_decimal val1 = {{56, 4294967295, 0, 2147483648}, 0};
  s21_decimal val2 = {{69, 1, 0, 2147483648}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
  ck_assert_int_eq(result, 0);
...
START_TEST(test_add_5) {
  s21_decimal val1 = {{4294967295, 4294967295, 4294967295, 2147483648}, 0};
  s21_decimal val2 = {{429, 0, 0, 2147483648}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
...
START_TEST(test_add_6) {
  s21_decimal val1 = {{4294967295, 4294967295, 4294967295, 0}, 0};
  s21_decimal val2 = {{405, 0, 0, 0}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
...
START_TEST(test_add_7) {
  s21_decimal val1 = {{5674, 4222, 1000, 0}, 0};
  s21_decimal val2 = {{45, 211, 98, 2147483648}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
  ck_assert_int_eq(result, 0);
...
START_TEST(test_add_8) {
  s21_decimal val1 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}, 0};
  s21_decimal val2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
  ck_assert_int_eq(result, 0);
...
START_TEST(test_add_9) {
  s21_decimal val1 = {{0x00000183, 0x00000000, 0x00000000, 0x00020000}, 0};
  s21_decimal val2 = {{0x00004DA6, 0x00000000, 0x00000000, 0x00020000}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
  ck_assert_int_eq(result, 0);
...
START_TEST(test_add_10) {
  s21_decimal val1 = {{0x77D5E3AA, 0x0000011C, 0x00000000, 0x00060000}, 0};
  s21_decimal val2 = {{0x00212155, 0x00000000, 0x00000000, 0x00070000}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  int result = s21_add(val1, val2, &res);
  ck_assert_int_eq(result, 0);
