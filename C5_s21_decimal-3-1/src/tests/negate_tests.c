...
START_TEST(s21_test_negate_0) {
  ...
  s21_decimal etalon = {{0, 0, 0, ~(S21_INT_MAX)}, 0};
...
START_TEST(s21_test_negate_1) {
  ...
  s21_decimal etalon = {{1, 0, 0, ~(S21_INT_MAX)}, 0};
  s21_decimal b = {{0, 0, 0, 0}, 0};
  s21_decimal* ptr_b = &b;
...
START_TEST(s21_test_negate_2) {
  s21_decimal a = {{1, 0, 0, ~(S21_INT_MAX)}, 0};
...
START_TEST(s21_test_negate_3) {
  ...
  s21_decimal etalon = {{100, 0, 0, ~(S21_INT_MAX)}, 0};
  s21_decimal b = {{0, 0, 0, 0}, 0};
  s21_decimal* ptr_b = &b;
  int add = s21_negate(a, ptr_b);
  ck_assert_int_eq(add, 0);
...
START_TEST(s21_test_negate_4) {
  s21_decimal a = {{100, 0, 0, ~(S21_INT_MAX)}, 0};
...
START_TEST(s21_test_negate_5) {
  ...
  s21_decimal etalon = {{S21_MAX_UINT, 0, 0, ~(S21_INT_MAX)}, 0};
  s21_decimal b = {{0, 0, 0, 0}, 0};
  s21_decimal* ptr_b = &b;
  int add = s21_negate(a, ptr_b);
  ck_assert_int_eq(add, 0);
...
START_TEST(s21_test_negate_7) {
  s21_decimal a = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, 0}, 0};
  s21_decimal etalon = {
      {S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, ~(S21_INT_MAX)}, 0};
  s21_decimal b = {{0, 0, 0, 0}, 0};
  s21_decimal* ptr_b = &b;
  int add = s21_negate(a, ptr_b);
  ck_assert_int_eq(add, 0);
...
START_TEST(s21_test_negate_8) {
  s21_decimal a = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, ~(S21_INT_MAX)},
                   0};
  s21_decimal etalon = {{S21_MAX_UINT, S21_MAX_UINT, S21_MAX_UINT, 0}, 0};
  s21_decimal b = {{0, 0, 0, 0}, 0};
  s21_decimal* ptr_b = &b;
...
START_TEST(negate_4) {
  s21_decimal val = {{55, 0, 0, S21_MINUS}, 0};
  s21_decimal res = {{0, 0, 0, 0}, 0};
  s21_negate(val, &res);
  int result = s21_is_not_equal(val, res);
