...
START_TEST(test_is_greater_or_equal_1) {
  ...
  int result = s21_is_greater_or_equal(dec_1, dec_2);
...
START_TEST(test_is_greater_or_equal_31) {
  s21_decimal dec_1 = {{1, 0, 0, S21_MINUS}, 0};
  s21_decimal dec_2 = {{12, 0, 0, S21_MINUS}, 0};
  int result = s21_is_greater_or_equal(dec_1, dec_2);
  ck_assert_int_eq(result, 1);
}
END_TEST
...
Suite *s21_is_greater_or_equal_test(void) {
  ...
  s = suite_create("s21_is_greater_or_equal_test");
