# Project Team 01 — С#_Bootcamp

Резюме: в этом командном проекте тебе предстоит разработать консольное игровое roguelike-приложение на языке программирования С# с использованием библиотеки curses (в версии dotnet-curses для C#) в духе классической игры Rogue 1980 года разработки.
...
Игровое приложение:
 - должно быть реализовано на языке C# версии 12;
 - должно быть кроссплатформенным;
 - должно иметь консольный интерфейс на базе библиотеки dotnet-curses;
 - должно иметь стартовое меню, в котором предлагается начать новую игровую сессию, продолжить последний сеанс, получить таблицу лидеров или выйти из игры;
...
Реализуй с dotnet-curses рендеринг игры в **presentation**-слое, используя необходимые сущности **domain**.
...
- Для 3D-рендеринга комнат и коридоров используй алгоритм Ray Casting и библиотеку dotnet-curses.
